...
Guidelines follow the Google Developer's Style Guide on UI elements and interactions.
...
| Choosing one or more elements from a group component | <li>Checkbox group</li><li>List item: single select, multi-select</li><li>Menu item</li><li>Radio button group</li> | Select | Clear the selection |

## Component types

The following table describes which preposition to use when describing interactions with different component types:

| Component | Preposition | Example |
| --- | --- | --- |
| Window | In | `In the **<product>** window, click **Login**.` |
| Page | On | `On the **Jobs** page, click **Run Job**.` |
...
## Example UI component interactions

Use the following examples to help you consistently describe interactions with UI components.
